...
public  class  ActionUtil {
	...
	public void swipeRightToLeft(AndroidDriver driver) throws InterruptedException
	...
	public  void swipeElement_weather(AndroidDriver driver,WebElement el, int hourY)
	...
	public void swipeBottomToTop(AndroidDriver<MobileElement> driver) throws InterruptedException
	{
	...
	public void tapOnentrBtn(AndroidDriver<MobileElement> driver) throws InterruptedException
	{
	...
	public void checkweather_details(AndroidDriver<MobileElement> driver) throws InterruptedException

	{
		// get the weather timings and Add weather timingd details in List and
		// retrive
		...
		for (int i = 0; i<6; i++) {
			Thread.sleep(2000);
			swipeElement_weather(driver, element, hourY);
		...
		for (int k = 0; k < tempTimeList.length; k++) {
			for (int m = 0; m < finalTimeList.size(); m++) {
				if (finalTimeList.get(m).equals(tempTimeList[k])) {
					//System.out.println("////////////////////////////////////////////////////////////////Duplicate found"+ tempTimeList[k]);
					duplicate = true;
					break;
				}
			}
